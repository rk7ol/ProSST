...
S3_BASE_URI_DEFAULT="s3://plm-ml/code/prosst"
...
aws "${aws_args[@]}" s3 cp "${SCRIPT_DIR}/requirements_sagemaker.txt" "${base_uri%/}/requirements_sagemaker.txt" --only-show-errors "${aws_dryrun[@]}"
